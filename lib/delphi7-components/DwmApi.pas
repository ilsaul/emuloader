...
function DrawThemeTextEx(hTheme: Longword; hdc: HDC; iPartId, iStateId: Integer; pszText: PWideChar;
                         iCharCount: Integer; dwFlags: Longword; pRect: PRect; var Options: TDTTOPTS): Longword;
                         stdcall; external 'uxtheme.dll';
...
function DwmSetIconicLivePreviewBitmap; external ModName name 'DwmSetIconicLivePreviewBitmap';// delayed;
