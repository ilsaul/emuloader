...
{TNT-WARN TCustomRichEdit}
  ...
  private
    ...
    FOnURLClick: TURLClickEvent; // added by Ciro Alfredo Consentino (March 02, 2021)
    procedure CNNotify(var Message: TWMNotify); message CN_NOTIFY;
    procedure WMGetTextLength(var Message: TWMGetTextLength); message WM_GETTEXTLENGTH;
  ...
  protected
    procedure DoURLClick (const URL: WideString); // added by Ciro Alfredo Consentino (March 02, 2021)
  ...
  published
    property Hint: WideString read GetHint write SetHint stored IsHintStored;
    property OnURLClick: TURLClickEvent read FOnURLClick write FOnURLClick; // added by Ciro Alfredo Consentino (March 02, 2021)
  end;
...
begin
  ...
  SendMessage(Handle, EM_EXLIMITTEXT, 0, $FFFFFF); // limit to 16Mb
end;
...
begin
  if (not Win32PlatformIsUnicode) then
    ...
    Result := SendMessageW(Handle, EM_FINDTEXTEXW, Flags, LongInt(@Find)); // changed by Ciro "EM_FINDTEXT" (March 01, 2021)
