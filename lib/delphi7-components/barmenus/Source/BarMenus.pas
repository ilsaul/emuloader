...
type
  ...
  TBcDrawStyle    = (dsNormal, dsTile, dsStretch);
...
resourcestring
  ...
  BcResourceSubMenuItem  = 'BCSUBMENUITEM';
  BcResourceSubMenuItem2 = 'BCSUBMENUITEM2';
  BcWinKeyString = 'Win+';
...
type
  ...
  { Methods }
    ...
    function  GetMenuBorderColor: TColor; // added by Ciro Alfredo Consentino (May 31, 2019)
    procedure SetMenuBorderColor(Value: TColor); // added by Ciro Alfredo Consentino (May 31, 2019)
    function  GetMenuBorderInnerColor: TColor; // added by Ciro Alfredo Consentino (May 31, 2019)
    procedure SetMenuBorderInnerColor(Value: TColor); // added by Ciro Alfredo Consentino (May 31, 2019)
  ...
  { Public }
    ...
    property MenuBorderColor: TColor read GetMenuBorderColor write SetMenuBorderColor; // added by Ciro Alfredo Consentino (May 31, 2019)
    property MenuBorderInnerColor: TColor read GetMenuBorderInnerColor write SetMenuBorderInnerColor; // added by Ciro Alfredo Consentino (May 31, 2019)
  ...
  published
    ...
    property VertAlignment: TVertAlignment read FVertAlignment write FVertAlignment default DefaultBarBitmapVertAlignment;
    property HorzAlignment: THorzAlignment read FHorzAlignment write FHorzAlignment default DefaultBarBitmapHorzAlignment;
  ...
  private
    FDrawStyle: TBcDrawStyle;
  protected
  public
    constructor Create(AOwner: TMenu); override;
    destructor  Destroy; override;
  published
    property DrawStyle: TBcDrawStyle read FDrawStyle write FDrawStyle default DefaultBarBackBitmapDrawStyle;
...
{    property OffsetX: Integer read FOffsetX write FOffsetX default 0;}
  ...
  private
    ...
    FMenuBorderColor: TColor; // added by Ciro Alfredo Consentino (May 31, 2019)
    FMenuBorderInnerColor: TColor; // added by Ciro Alfredo Consentino (May 31, 2019)
  ...
  protected
    ...
    property MenuBorderColor: TColor read GetMenuBorderColor write SetMenuBorderColor default clBtnShadow; // added by Ciro Alfredo Consentino (May 31, 2019)
    property MenuBorderInnerColor: TColor read GetMenuBorderInnerColor write SetMenuBorderInnerColor default clWhite; // added by Ciro Alfredo Consentino (May 31, 2019)
  public
    { Public declarations }
  ...
  published
    ...
    property Flat;
    property MenuBorderColor; // added by Ciro Alfredo Consentino (May 31, 2019)
    property MenuBorderInnerColor; // added by Ciro Alfredo Consentino (May 31, 2019)
    property MenuFont;
    property MenuStyle;
...
begin
  ...
  begin
    ...
    // draw the custom border first
    DrawMenuWindowBorder(BarMenusIntf, WindowHandle); // added by Ciro Alfredo Consentino (July 18, 2019)
...
//        if ((UserFlags and USERDATA_BORDERDRAWN) = 0) then
        begin
          ...
          try
            ...
            WindowCanvas.Brush.Color := BarMenusIntf.MenuBorderColor;
            R := Rect(0, 0, RectWidth(WindowRect), RectHeight(WindowRect));
            with R do
              WindowCanvas.FrameRect(R);

            InflateRect(R, -1, -1); // use another InflateRect(R, -1, -1); to the "inner inner" white frame!

            WindowCanvas.Brush.Color := BarMenusIntf.MenuBorderInnerColor;
            with R do
              WindowCanvas.FrameRect(R);

            // added by Ciro Alfredo Consentino (May 30, 2019)
            InflateRect(R, -1, -1);
            with R do
              WindowCanvas.FrameRect(R);
            ...
            begin
              ...
              begin
                ...
                Pen.Color := BarMenusIntf.MenuBorderColor;
...
begin
  ...
  FMenuBorderColor := clBtnShadow; // added by Ciro Alfredo Consentino (May 31, 2019)
  FMenuBorderInnerColor := clWhite; // added by Ciro Alfredo Consentino (May 31, 2019)
...
procedure TBcCustomBarPopupMenu.SetMenuBorderColor(Value: TColor); // added by Ciro Alfredo Consentino (May 31, 2019)
begin
  FMenuBorderColor := Value;
end;

procedure TBcCustomBarPopupMenu.SetMenuBorderInnerColor(Value: TColor); // added by Ciro Alfredo Consentino (May 31, 2019)
begin
  FMenuBorderInnerColor := Value;
end;
...
function TBcCustomBarPopupMenu.GetMenuBorderColor: TColor; // added by Ciro Alfredo Consentino (May 31, 2019)
begin
  Result := FMenuBorderColor;
end;

function TBcCustomBarPopupMenu.GetMenuBorderInnerColor: TColor; // added by Ciro Alfredo Consentino (May 31, 2019)
begin
  Result := FMenuBorderInnerColor;
end;
...
procedure TBcCustomBarMainMenu.SetMenuBorderColor(Value: TColor); // added by Ciro Alfredo Consentino (May 31, 2019)
begin
  FMenuBorderColor := Value;
end;

procedure TBcCustomBarMainMenu.SetMenuBorderInnerColor(Value: TColor); // added by Ciro Alfredo Consentino (May 31, 2019)
begin
  FMenuBorderInnerColor := Value;
end;
...
function TBcCustomBarMainMenu.GetMenuBorderColor: TColor; // added by Ciro Alfredo Consentino (May 31, 2019)
begin
  Result := FMenuBorderColor;
end;

function TBcCustomBarMainMenu.GetMenuBorderInnerColor: TColor; // added by Ciro Alfredo Consentino (May 31, 2019)
begin
  Result := FMenuBorderInnerColor;
end;
