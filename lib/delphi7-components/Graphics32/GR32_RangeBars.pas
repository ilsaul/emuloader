...
type
  ...
  private
    ...
    procedure SetArrowColor(Value: TColor); // added by Ciro Alfredo Consentino (June 20, 2019)
...
{$ENDIF}
  ...
  published
    ...
    property ArrowColor; // added by Ciro Alfredo Consentino (June 20, 2019)
    property Increment;
    property Kind;
    property Range;
    property Style;
  ...
  published
    ...
    property ShadowColor;
    property BorderColor;
    property ArrowColor; // added by Ciro Alfredo Consentino (June 15, 2019)
    property HandleSize;
    property Kind;
    ...
    property Min;
    property ShowArrows;
    property ShowHint; // added by Ciro Alfredo Consentino [July 15, 2007]
    property ShowHandleGrip;
    property Style;
  ...
  private
    ...
    function GetArrowColor: TColor; // added by Ciro Alfredo Consentino (June 20, 2019)
  ...
  published
    ...
    property ArrowColor:TColor read GetArrowColor write SetArrowColor default clWindowFrame; // added by Ciro Alfredo Consentino (June 20, 2019)
...
{$ENDIF}
  ...
  begin
    ...
    begin
      ...
      DrawArrow(Canvas, R, Direction, fArrowColor); // fBorderColor); // modified by Ciro Alfredo Consentino (June 20, 2019)
    end;
  end;
end;
...
// added by Ciro Alfredo Consentino (June 20, 2019)
procedure TArrowBar.SetArrowColor(Value: TColor);
begin
...
// added by Ciro Alfredo Consentino (June 20, 2019)
function TArrowBarAccess.GetArrowColor: TColor;
begin
  Result := FMaster.ArrowColor;
end;
...
// added by Ciro Alfredo Consentino (June 20, 2019)
procedure TArrowBarAccess.SetArrowColor(Value: TColor);
begin
  FMaster.ArrowColor := Value;
  if FSlave <> nil then FSlave.ArrowColor := Value;
end;
