...
uses
  ...
  GR32, GR32_Resamplers {$IFDEF Ex},GR32_ResamplersEx {$ENDIF}, GraphicEx;
...
begin
  ...
  // load example image
  Assert(FileExists(MediaPath + 'testimage.png'));
  ResamplingSrc.LoadFromFile(MediaPath + 'testimage.png');
