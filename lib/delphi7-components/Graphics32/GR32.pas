...
var
  ...
  P: TPicture;
begin
  FileStream := TFileStream.Create(Filename, fmOpenRead or fmShareDenyNone); // "or fmShareDenyNone" added to avoid crash when using threads
  try                                                                        // by Ciro Alfredo Consentino - 05 May 2015
