...
const
  MaxSize = High(Integer); // edited by Ciro, to remove the limitation of icons ammount
begin
...
begin
  FHandle := ImageList_Create(Width, Height, ILC_COLOR32 or Mask[Masked],
    AllocBy, AllocBy); // edited by Ciro to add support for alpha blend icons, 32-bits
...
begin
// removed by Ciro, to add support for rectangular icons like 32x16
{  if Image <> nil then
    with Image do
