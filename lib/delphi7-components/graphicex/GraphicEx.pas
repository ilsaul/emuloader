...
type
  ...
  protected
    ...
    procedure ReadChannelData(var Run: PChar; var Channel: TPSDChannel; Width, Height: Cardinal; IsIrrelevant: Boolean);
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        Line := Scanline[Y];
        Move(Source^, Line^, BitsPerPixel * Width div 8);
        Inc(Source, BitsPerPixel * (Width + FromSkew) div 8);
        Inc(Y, RowInc);
        Dec(RowCount);
      end;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            Move(Source^, Line^, BitsPerPixel * PixelCount div 8);
        ...
        begin
          ...
          begin
            Line := Scanline[Y];
            Inc(Line, ColumnOffset);
            Move(Source^, Line^, BitsPerPixel * TileWidth div 8);
    ...
    try
      ...
      try
        ...
        begin
          ...
          begin
            // Monochrome or palette images with 1, 2, 4 and 8 bits per pixel.
            ...
            begin
              ...
              begin
                // Create the palette from the three maps. Set source resolution too, to avoid unnecessary conversions.
...
procedure TPSDGraphic.ReadChannelData(var Run: PChar; var Channel: TPSDChannel; Width, Height: Cardinal;
  ...
  if Result then
    ...
    begin
      ...
      begin
        ...
        // color space
        FMode := Header.Mode;
        ColorScheme := DetermineColorScheme(FChannels);
...
begin
  ...
  begin
    ...
    begin
      ...
      Freemem(FRawBuffer); // There is some memory used by ReadImageProperties.
      FRawBuffer := nil;
      ColorManager.SourceOptions := [coNeedByteSwap];
      try
        // read IHDR chunk
