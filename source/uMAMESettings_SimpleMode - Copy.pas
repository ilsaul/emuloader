...
type
  TFormMAMESettings_SimpleMode = class(TForm)
    ...
    procedure ButtonSwitchFullModeClick(Sender: TObject);
...
procedure TFormMAMESettings_SimpleMode.EnableDisableControls;
begin
...
procedure TFormMAMESettings_SimpleMode.ButtonSwitchFullModeClick(Sender: TObject);
begin
  ShowMessageW('Feature not implemented yet!'+#13#10+'Paths and a few settings will be added to the basic mode.', 'Emu Loader');
end;
