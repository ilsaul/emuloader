...
begin
  ...
  LabelYear.Caption:= FormMain.List.Column[1].Caption;
  LabelManufacturer.Caption:= FormMain.List.Column[2].Caption;
  LabelSound.Caption:= FormMain.List.Column[3].Caption;
  LabelFrequency.Caption:= FormMain.List.Column[4].Caption;
  LabelSamples.Caption:= FormMain.List.Column[5].Caption;
  LabelControlType.Caption:= FormMain.List.Column[6].Caption;
  LabelVideo.Caption:= FormMain.List.Column[7].Caption;
  LabelOrientation.Caption:= FormMain.List.Column[8].Caption;
  LabelResolution.Caption:= FormMain.List.Column[9].Caption;
  LabelDriverStatus.Caption:= FormMain.List.Column[10].Caption;
  LabelSoundStatus.Caption:= FormMain.List.Column[11].Caption;
  LabelColorStatus.Caption:= FormMain.List.Column[12].Caption;
  LabelMerged.Caption:= FormMain.List.Column[13].Caption;
  LabelName.Caption:= FormMain.List.Column[14].Caption;
  LabelCloneOf.Caption:= FormMain.List.Column[15].Caption;
  LabelCategory.Caption:= FormMain.List.Column[16].Caption;
  LabelVersionAdded.Caption:= FormMain.List.Column[17].Caption;
  LabelDriver.Caption:= FormMain.List.Column[18].Caption;
