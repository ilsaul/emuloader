...
type
  TFormRunGameExtraMAME = class(TForm)
    ...
    ButtonRecordMovieResetFileNameTitle: TBitBtn;
    ...
    RecordMovieListViewFileFolder: TShape;
...
procedure TFormRunGameExtraMAME.ReSelectRecordMovieFile;
var
  Item: TEasyItem;
  GameFound: Boolean;
  iFileStr, ItemFileStr: String;
...
begin
  ...
  FormRunGameExtraMAME.Width:= FormRunGameExtraMAME.Width-iWidthDec;
  FormRunGameExtraMAME.Height:= FormRunGameExtraMAME.Height-iHeight;
...
function TFormRunGameExtraMAME.GetRecordMovieFileExtension: String;
begin
...
procedure TFormRunGameExtraMAME.RecordMovieFilter_FileType;
var
  Item: TEasyItem;
  FileExtStr: String;
begin
...
procedure TFormRunGameExtraMAME.RecordMovieAVIClick(Sender: TObject);
begin
...
procedure TFormRunGameExtraMAME.RecordMovieListViewColumnClick(
  Sender: TCustomEasyListview; Button: TCommonMouseButton;
  ShiftState: TShiftState; const Column: TEasyColumn);
begin
  if Button = cmbLeft then
...
function TFormRunGameExtraMAME.RecordMovieListViewItemCompare(
  Sender: TCustomEasyListview; Column: TEasyColumn; Group: TEasyGroup;
  Item1, Item2: TEasyItem; var DoDefault: Boolean): Integer;
var
  gItem1, gItem2: TEasyItem;
...
procedure TFormRunGameExtraMAME.RecordMovieListViewItemEdited(
  Sender: TCustomEasyListview; Item: TEasyItem; var NewValue: Variant;
  var Accept: Boolean);
var
  oldFile, newFile: String;
...
procedure TFormRunGameExtraMAME.RecordMovieListViewItemEditEnd(
  Sender: TCustomEasyListview; Item: TEasyItem);
begin
  EditFileName_EndEdit_ELV(RecordMovieListView);
end;

procedure TFormRunGameExtraMAME.RecordMovieListViewItemSelectionChanged(
  Sender: TCustomEasyListview; Item: TEasyItem);
begin
  if Item.Selected then
     begin
...
procedure TFormRunGameExtraMAME.RecordMovieListViewKeyAction(
  Sender: TCustomEasyListview; var CharCode: Word; var Shift: TShiftState;
  var DoDefault: Boolean);
begin
...
procedure TFormRunGameExtraMAME.ButtonRecordMovieResetFileNameClick(
  Sender: TObject);
begin
...
procedure TFormRunGameExtraMAME.RecordMovieFileNameChange(Sender: TObject);
begin
  case RecordMovieListView.Tag of
...
procedure TFormRunGameExtraMAME.RecordMovieFileNameKeyPress(
  Sender: TObject; var Key: Char);
begin
