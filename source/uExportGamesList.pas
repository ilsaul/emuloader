...
type
  TFormExportGamesList = class(TForm)
...
var
  FormExportGamesList: TFormExportGamesList;
...
procedure TFormExportGamesList.FormShow(Sender: TObject);
begin
...
procedure TFormExportGamesList.ExportListItemPaintText(
