...
*)
  ...
  ['{23170F69-40C1-278A-0000-000400A00000}']
    function CryptoSetCRC(crc: DWORD): HRESULT; stdcall;
  end;
...
//******************************************************************************
  ...
  ['{022CF785-3ECE-46EF-9755-291FA84CC6C9}']
    ...
    function GetItemCRC(const index: integer): DWORD; stdcall; // added by Ciro Alfredo Consentino (June 09, 2013)
    ...
    property ItemCRC[const index: integer]: DWORD read GetItemCRC; // added by Ciro Alfredo Consentino (June 09, 2013)
...
// added by Ciro Alfredo Consentino (June 09, 2013)
function T7zInArchive.GetItemCRC(const index: integer): DWORD; stdcall;
var
  eCRC: OleVariant;
begin
  eCRC:= GetItemProp(index, kpidCRC);
  Result:= PropVariant(eCRC).uhVal.QuadPart;
end;
