object FormMAMESettings_SimpleMode: TFormMAMESettings_SimpleMode
    ...
    object TPage
      ...
      object FolderROMs: TEasyListview
        ...
        Header.Columns.Items = {
          ...
          0006000000800800010100010000000000000123020000FFFFFF1F0001000000
  ...
  object ButtonSwitchFullMode: TBitBtn
    Left = 231
    Top = 429
    Width = 124
    Height = 25
    Hint = 
      'Switch to a mode with all settings (for latest emulator builds o' +
      'nly)'
    Caption = 'Switch to Full Mode'
    TabOrder = 8
    Visible = False
    OnClick = ButtonSwitchFullModeClick
  end
