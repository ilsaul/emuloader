object FormSelectFile: TFormSelectFile
  ...
  object SelectFile_FilesListView: TEasyListview
    Left = -1
    Top = 74
    Width = 606
    Height = 207
    ...
    OnColumnClick = SelectFile_FilesListViewColumnClick
    OnDblClick = SelectFile_FilesListViewDblClick
    OnItemCompare = SelectFile_FilesListViewItemCompare
    OnItemPaintText = SelectFile_FilesListViewItemPaintText
    OnItemSelectionChanged = SelectFile_FilesListViewItemSelectionChanged
    OnKeyAction = SelectFile_FilesListViewKeyAction
  end
