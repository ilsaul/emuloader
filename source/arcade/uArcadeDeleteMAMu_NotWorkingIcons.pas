...
begin
  ...
  if LabelHotKeys.Tag in [1, 2] then
     begin
       ...
       TNotWorkingGameInfo(addItem).eName:= FormArcadeMAMu_IconsManager.SourceIconFile; //'zzz.ico';
...
begin
  ...
  FreeAndNil(Icon32);
  NotWorkingIcons.BeginUpdate;
  TNotWorkingGameInfo(Item).eName:= FormArcadeMAMu_IconsManager.SourceIconFile;
  NotWorkingIcons.EndUpdate;
end;
...
begin
  ...
  FormArcadeMAMu_IconsManager.SourceIconFile:= NewFileStr;
  ReplaceZZZIcon;
end;
