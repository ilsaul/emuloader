...
var
  FormArcadeDeleteCloneImages: TFormArcadeDeleteCloneImages;
...
procedure TFormArcadeDeleteCloneImages.LoadImages;
var
...
procedure TFormArcadeDeleteCloneImages.DeleteFiles(SelectedOnly: Boolean = False);
var
...
procedure TFormArcadeDeleteCloneImages.RenameImages;
var
...
procedure TFormArcadeDeleteCloneImages.SelectImageCategory;
var
  selCat: ShortInt;
begin
...
procedure TFormArcadeDeleteCloneImages.BuildGamesList;
var
...
procedure TFormArcadeDeleteCloneImages.SetSelectedGame(AutoSelect: Boolean = True);
begin
  ClearScreens;
...
procedure TFormArcadeDeleteCloneImages.ClearScreens;
begin
...
procedure TFormArcadeDeleteCloneImages.UpdateTotalGamesLabel;
begin
...
procedure TFormArcadeDeleteCloneImages.DeleteClonesListItemPaintText(
...
procedure TFormArcadeDeleteCloneImages.FormCloseQuery(Sender: TObject;
...
procedure TFormArcadeDeleteCloneImages.DeleteClonesListColumnClick(
...
procedure TFormArcadeDeleteCloneImages.DeleteClonesListItemSelectionChanged(
  Sender: TCustomEasyListview; Item: TEasyItem);
begin
...
procedure TFormArcadeDeleteCloneImages.DeleteClonesListKeyAction(
...
procedure TFormArcadeDeleteCloneImages.ButtonHelpClick(Sender: TObject);
begin
...
procedure TFormArcadeDeleteCloneImages.ButtonRenameToParentClick(
  Sender: TObject);
begin
  RenameImages;
  DeleteClonesList.SetFocus;
...
procedure TFormArcadeDeleteCloneImages.ButtonRemoveSelectedClick(Sender: TObject);
begin
...
procedure TFormArcadeDeleteCloneImages.ButtonScanClick(Sender: TObject);
begin
  BuildGamesList;
end;

procedure TFormArcadeDeleteCloneImages.ButtonDeleteImagesClick(Sender: TObject);
begin
  DeleteFiles;
end;

procedure TFormArcadeDeleteCloneImages.ButtonDeleteSelectedClick(Sender: TObject);
begin
  DeleteFiles(True);
end;


function TFormArcadeDeleteCloneImages.DeleteClonesListItemCompare(
...
procedure TFormArcadeDeleteCloneImages.SystemIconClick(Sender: TObject);
begin
  SelectSystem;
end;

procedure TFormArcadeDeleteCloneImages.ImageCategoryIconClick(Sender: TObject);
begin
  SelectImageCategory;
end;
