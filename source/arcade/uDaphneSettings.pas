...
type
  TFormDaphneSettings = class(TForm)
    TopBar: TPanelEx;
    GeneralBox: TAdvGroupBox;
    Label2: TLabel;
    LaserDiscType: TComboBox;
    Daphne_NoJoysticks: TAdvOfficeCheckBox;
    SRAMContinuousUpdate: TAdvOfficeCheckBox;
    FastBoot: TAdvOfficeCheckBox;
    StopLaserdiscPlayer: TAdvOfficeCheckBox;
    Daphne_NoLog: TAdvOfficeCheckBox;
    Daphne_NoWarnings: TAdvOfficeCheckBox;
    SendUsageStatistics: TAdvOfficeCheckBox;
    EnableCheat: TAdvOfficeCheckBox;
    AdvGroupBox4: TAdvGroupBox;
    Label3: TLabel;
    ScreenResolution: TComboBox;
    Daphne_FullScreen: TAdvOfficeCheckBox;
    FullScale: TAdvOfficeCheckBox;
    IgnoreAspectRatio: TAdvOfficeCheckBox;
    Daphne_OpenGL: TAdvOfficeCheckBox;
    BlankSearches: TAdvOfficeCheckBox;
    BlankSkips: TAdvOfficeCheckBox;
    AudioBox: TAdvGroupBox;
    NoSound: TAdvOfficeCheckBox;
    Daphne_PreferSamples: TAdvOfficeCheckBox;
    ButtonReadFile: TBitBtn;
    ButtonOk: TBitBtn;
    ButtonCancel: TBitBtn;
    LabelAudioVolumeVLDP: TLabel;
    AudioVolumeVLDP: TGaugeBar;
    IdleExit: TAdvOfficeCheckBox;
