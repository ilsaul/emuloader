...
begin
  ...
  if (Len <> CB_ERR) and (Len > 0) then // if Len <> CB_ERR then
  begin
...
begin
  ...
  case Message.Msg of
    ...
    WM_MOUSEMOVE: Perform(Message.Msg, Message.WParam, Message.LParam); // added by Ciro Alfredo Consentino (July 17, 2019)
    WM_SETFONT:
      if NewStyleControls then
...
begin
  case Message.NotifyCode of
    ...
    CBN_SELCHANGE:
      begin
        if ItemIndex <> -1 then // fix added by Ciro Alfredo Consentino (July 17, 2019)
        begin
