object Form4KModeDesigns: TForm4KModeDesigns
  Left = 1013
  Top = 222
  Width = 2324
  Height = 1520
  Caption = '4K Mode Designs - WIP (not compiled with Emu Loader)'
  Color = clBtnFace
  ...
  object LabelTotalPlayTime: TShadowLabel
    ...
    Width = 252
    Height = 31
    Caption = '0000 days, 33:33:33 (0000x)'
    ShadowColor = clGray
    ShadowEnabled = False
    EllipsType = etNone
    ColorFrame = clBlack
  ...
  object ShadowLabel4: TShadowLabel
    ...
    Alignment = taCenter
    AutoSize = False
    Caption = 'Image Size: 128x128 pixels'
    Font.Charset = ANSI_CHARSET
    Font.Color = clBlack
    Font.Height = -24
    Font.Name = 'Segoe UI'
  ...
  object ShadowLabel5: TShadowLabel
    ...
    Height = 97
    Alignment = taCenter
    Caption = 'ColorBoxEx Hint Text (2 Lines)'
    Font.Charset = ANSI_CHARSET
    Font.Color = clBlack
    Font.Height = -24
    Font.Name = 'Segoe UI'
  ...
  object ShadowLabel6: TShadowLabel
    ...
    Width = 241
    Height = 47
    Caption = 'verdana 14 with 2 lines, custom parameters'
    Font.Charset = ANSI_CHARSET
    Font.Color = clBlack
    Font.Height = -19
    Font.Name = 'Verdana'
  ...
  object ShadowLabel15: TShadowLabel
    ...
    Width = 217
    Height = 24
    Caption = 'verdana 14 with 1 line'
    Font.Charset = ANSI_CHARSET
    Font.Color = clBlack
    Font.Height = -19
    Font.Name = 'Verdana'
  ...
  object ShadowLabel16: TShadowLabel
    ...
    Width = 180
    Height = 27
    Caption = 'verdana 8 with 2 lines, custom parameters'
    Font.Charset = ANSI_CHARSET
    Font.Color = clBlack
    Font.Height = -11
    Font.Name = 'Verdana'
  ...
  object PanelBottom_CustomizeGameFonts: TPanelEx
    Left = 16
    Top = 530
    Width = 1553
    Height = 90
    ...
    object GamesBackgroundColor: TColorBoxEx
      ...
      Selected = clInactiveCaptionText
  ...
  object PanelEx2: TPanelEx
    ...
    object DriverStatusCategory: TComboBox2Ex
      ...
      ParentFont = False
      TabOrder = 2
      Text = 'Emulation Status (MAME Only)'
      Items.Strings = (
