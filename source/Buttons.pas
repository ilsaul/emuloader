...
type
  ...
  published
    ...
    property OnEnter;
    property OnExit;
    property FocusRect: Boolean read FFocusRect write FFocusRect default False;
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      //if ToolButton <> ttbToolbarDontCare then
      //  Canvas.Font.Color := clHighlightText; // removed by Ciro Alfredo Consentino - Feb 16, 2013
      Offset := Point(1, 0);
    end
    else
      Offset := Point(0, 0);
