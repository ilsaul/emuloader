...
var
  ...
  begin
    ...
    begin
      ...
      begin
        addItem:= ROMsListView.Items.AddCustom(TEasyScanInfo, addGroup);
        romCRC:= TEasyGameInfo(checkItem).eROMInfo.Names[LoopROMs];
...
begin
  ...
  if ROMsListView.Scrollbars.VertBarVisible then
     ROMsListView.Header.Columns[0].Width:= ROMsListView.Header.Columns[0].Width-GetSystemMetrics(SM_CXVSCROLL);//17;
