object FormRunGameExtraMAME: TFormRunGameExtraMAME
  Left = 756
  Top = 449
  ...
  object PanelTop: TPanelEx
    ...
    object LabelGameNameCloneOf: TShadowLabel
      ...
      Height = 25
      Caption = 
        'gamename [clone of parentname] [bios: biosname] [merged set] [xm' +
        'l file: filename]'#13#10'Emulator version'
      Font.Charset = ANSI_CHARSET
      Font.Color = 3289650
      Font.Height = -9
      Font.Name = 'Verdana'
  ...
  object NotebookPages: TNotebook
    ...
    object TPage
      ...
      object InputListView: TEasyListview
        ...
        Header.Columns.Items = {
          ...
          01C8000000FFFFFF1F0001000000010000000600000046006F006C0064006500
    ...
    object TPage
      ...
      object ButtonRecordMovieUsageInfo: TBitBtn
        Left = 536
        Top = 216
        Width = 60
        Height = 21
        Hint = 'Usage info and tips'
        Caption = 'Read Me!'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Height = -12
      ...
      object ButtonRecordMovieResetFileName: TBitBtn
        ...
        Height = 21
        Hint = 
          'Click here to reset filename to game name (selected folder is ma' +
          'intained)'
        Caption = 'Reset'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
      ...
      object ButtonRecordMovieSelectFile: TBitBtn
        Left = 440
        Top = 216
        Width = 47
        Height = 21
