...
begin
  ...
  FormMain.AddMsgText(', ');
  FormMain.AddMsgText('titles', MsgTxtColors.colorKeyTitle, [fsBold]);
  FormMain.AddMsgText(', ');
  FormMain.AddMsgText('emulator command line parameters', MsgTxtColors.colorKeyTitle, [fsBold]);
  FormMain.AddMsgText(' and ');
  FormMain.AddMsgText('games folders', MsgTxtColors.colorKeyTitle, [fsBold]);
  FormMain.AddMsgText('.'+#13#10+#13#10+
                      'Remember to insert a ');
  FormMain.AddMsgText('%s', MsgTxtColors.colorFileName, [fsBold]);
  ...
  FormMain.AddMsgText('multiple floppy disks', MsgTxtColors.colorKeyTitle, [fsBold]);
  ...
  FormMain.AddMsgText(' folder for more details.'#13#10+#13#10+
                     '    You can use ');
  FormMain.AddMsgText('four (4) emulators per system', MsgTxtColors.colorKeyTitle, [fsBold]);
  FormMain.AddMsgText('. Do not use the same emulator filename more than once in the same system.'+#13#10+#13#10+
                     '    The ');
  FormMain.AddMsgText('Boot Disc Parameter', MsgTxtColors.colorKeyTitle, [fsBold]);
  FormMain.AddMsgText(' setting is used for CD/DVD images mounted on a virtual drive ');
  FormMain.AddMsgText('(Daemon Tools / Virtual CloneDrive / Alcohol 120%)', MsgTxtColors.colorKeyTitle, [fsBold]);
  FormMain.AddMsgText('.'+#13#10+
                     'Some emulators, like SSF (Sega Saturn), do not support loading games from a CD image.'+#13#10+#13#10+'    ');
  FormMain.AddMsgText('Parameter 2', MsgTxtColors.colorKeyTitle, [fsBold]);
...
begin
  ...
  FormMain.AddMsgText(': ');
  FormMain.AddMsgText('Daemon Tools', MsgTxtColors.colorKeyTitle, [fsBold]);
  FormMain.AddMsgText(', ');
  FormMain.AddMsgText('Elby Virtual CloneDrive', MsgTxtColors.colorKeyTitle, [fsBold]);
  FormMain.AddMsgText(', ');
  FormMain.AddMsgText('Alcohol 120% / 52%', MsgTxtColors.colorKeyTitle, [fsBold]);
  FormMain.AddMsgText('.'+#13#10+#13#10+
  ...
  FormMain.AddMsgText(#13#10+'- ');
  FormMain.AddMsgText('Virtual CloneDrive', MsgTxtColors.colorKeyTitle, [fsBold]);
  FormMain.AddMsgText(': ');
  ...
  FormMain.AddMsgText(', please use the proper section related to the application you are using.'+#13#10+
                      'The ');
  FormMain.AddMsgText('[Custom Virtual Drive]', MsgTxtColors.colorExitCode, [fsBold]);
  ...
  FormMain.AddMsgText('Play +mount image in virtual drive', MsgTxtColors.colorKeyTitle, [fsBold]);
