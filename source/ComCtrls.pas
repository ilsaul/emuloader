...
{ TProgressBar }
  ...
  private
    ...
    FSmooth: Boolean;
    procedure WMEraseBkgnd(var Message: TWmEraseBkgnd); message WM_ERASEBKGND; // added by Ciro, Jul 30, 2007
    // to fix Vista progress paiting bug
...
begin
  ...
  begin
    Style := Style or OrientationStyle[FOrientation] or
      ...
      ATickMarks[FTickMarks] or TBS_FIXEDLENGTH and not TBS_ENABLESELRANGE; // edited by Ciro Jan 28, 2008!!
    WindowClass.style := WindowClass.style and not (CS_HREDRAW or CS_VREDRAW) or
      CS_DBLCLKS;
...
begin
  // added by Ciro, Jul 30, 2007 to fix Vista progress paiting bug
  DefaultHandler(Message);
end;
...
begin
  ...
  SendMessage(Handle, EM_SETEVENTMASK, 0,
    ...
    ENM_PROTECTED or ENM_LINK); // ENM_LINK added by Ciro Alfredo Consentino (Feb 12, 2014)
...
begin
  Result := Perform(CB_GETITEMHEIGHT, 0, 0); // added by Ciro to fix the 16 pixels height limitation
  // Result := 16; // obsolete
end;
